...
(defun-inline kb-object-manager-name (kbom) (kbom-name kbom))
(defun-inline kb-object-manager-content-lock (kbom) (kbom-content-lock kbom))
(defun-inline kb-object-manager-lru-size-percentage (kbom) (kbom-lru-size-percentage kbom))
(defun-inline kb-object-manager-content-table (kbom) (kbom-content-table kbom))
(defun-inline kb-object-manager-usage-table (kbom) (kbom-usage-table kbom))
(defun-inline kb-object-manager-lru-information (kbom) (kbom-lru-information kbom))
(defun-inline kb-object-manager-file-vector (kbom) (kbom-file-vector kbom))
(defun-inline kb-object-manager-id-threshold (kbom) (kbom-id-threshold kbom))
(defun-inline kb-object-manager-load-func (kbom) (kbom-load-func kbom))
(defun-inline kb-object-manager-meter-swap-time? (kbom) (kbom-meter-swap-time? kbom))
