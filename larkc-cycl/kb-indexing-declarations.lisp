...
(defun-inline kb-indexing-declaration-store ()
  *kb-indexing-declaration-store*)

(defun-inline add-index-to-kb-indexing-declaration-store (index plist)
  (setf (gethash index *kb-indexing-declaration-store*) plist))

(defun-inline get-index-from-kb-indexing-declaration-store (index)
...
(defun-inline get-index-key-prop (key-info indicator &optional default)
  (getf key-info indicator default))

(defun-inline get-index-prop (index indicator)
  (getf (get-index-from-kb-indexing-declaration-store index) indicator))

(defun-inline declare-index (index plist)
